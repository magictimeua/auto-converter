...
if __name__ == '__main__':
    category_mappings = [
        ...
        ('Комбінезони\сітки', 'Комбінезони та Сітки'),
        ('Чулки/колготки', 'Панчохи та Колготки'),
        ('Стрінги\трусики', 'Стрінги та Трусики'),
        ('Догляд за іграшками \ латексом', 'Догляд за іграшками та латексом'),
        ('Бондажи\фіксатори', 'Бондажи та Фіксатори'),
        ('Батоги, пір\'їнки', 'Батоги та пір’їнки'),
        ('Збільшення члену\попи\грудей', 'Стимулюючі засоби'),
        ('Пробники', 'Тестери'),
        ('Насадки, кільця', 'Насадки та кільця'),
        ('Жіночі помпи (клітора,сосків та грудей)', 'Жіночі помпи'),
        ('Помпи для чоловіків', 'Чоловічі помпи'),
        ('Ланцюжки, кульки, стимулятори', 'Ланцюжки, Кульки та Стимулятори'),
        ('Набір секс іграшок', 'Набори секс іграшок'),
        ('Розширювачі надувні', 'Надувні Розширювачі')
    ]
